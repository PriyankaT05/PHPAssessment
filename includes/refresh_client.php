<?php
	...
	if (mysqli_num_rows($result) == 0) {
		sendToClient("Couldn't find table 'repositories' in php_assessment database. Please click 'refresh database' button and try again.");
		exit();
	}
	...
	if ($rows == 0) {
		sendToClient("'repositories' table found in php_assessment database but query returned 0 results. Please click 'refresh database' button and try again.");
		exit();
	}
